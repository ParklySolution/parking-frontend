...
export const DocumentoTab: React.FC<DocumentoTabProps> = ({ 
  formData, 
  onInputChange,
  showAllFields = true
}) => {
  // Se non deve mostrare i campi documento, non renderizzare nulla
  if (!showAllFields) {
    return (
      <div style={{ padding: "20px", textAlign: "center", color: "#9ca3af" }}>
        <p>Nessun documento richiesto per questo tipo di contratto.</p>
      </div>
    );
  }
